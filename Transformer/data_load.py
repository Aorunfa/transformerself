...
source_train = '/home/chaofeng/DL-Demos/dldemos/Transformer/data/cn.txt'
target_train = '/home/chaofeng/DL-Demos/dldemos/Transformer/data/en.txt'
source_test = '/home/chaofeng/DL-Demos/dldemos/Transformer/data/cn.test.txt'
target_test = '/home/chaofeng/DL-Demos/dldemos/Transformer/data/en.test.txt'
...
def load_vocab(language):
    ...
    vocab = [
        line.split()[0] for line in codecs.open(
            '/home/chaofeng/DL-Demos/dldemos/Transformer/data/{}.txt.vocab.tsv'.format(language), 'r',
...
def create_data(source_sents, target_sents):
    ...
    for i, (x, y) in enumerate(zip(x_list, y_list)):
        X[i] = np.lib.pad(x, [0, maxlen - len(x)], # pppvvvppp, (padd_left_num, padd_right_num)
                          'constant',
                          constant_values=(0, 0))
